let introText = ["Watching", "Listening", "Imagining", "Where is our mind taking us", "Let's create our own dreamscape", "Paint slowly, faster, find your rhythm", "Then let your creation take you where you want to go with ‘trace’", "Enjoy \n \n Touch the screen to begin"];
let slide = 0;
let delayTime = 1000;
